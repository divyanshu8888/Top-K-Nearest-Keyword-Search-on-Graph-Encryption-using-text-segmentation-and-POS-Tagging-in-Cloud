  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h2 class="style10" >Users Search History  </h2>
          <p class="infopost">
		  <%@ include file="connect.jsp" %>
		  <table width="552">
                        <tr>
						<td width="100"><span class="style9">Username</span></td>
		...
		try 
	{
           ...
           String query="select distinct username,keyword,dt FROM search_history"; 
...
<p align="right"><a href="adminmain.jsp"></a></p>
	    </div>
      </div>
      <div class="sidebar">
