  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h2 class="style4" >Enter Your Secret Key to Search </h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
		<form action="search1.jsp" method="post">
            <table width="540">
              <tr>
                <td width="229" height="46"><span class="style4">Enter Your Secret key to Search </span></td>
                <td width="171"><input type="text" name="sk" /></td>
                <td width="124"><label>
            ...
            <p align="right"><a href="usermain.jsp" class="style2"></a></p>
