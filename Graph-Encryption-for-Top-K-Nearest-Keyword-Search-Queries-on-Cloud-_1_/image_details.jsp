  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h2 class="style4" ><em>Image Details </em></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
					...
					<%
						...
						try 
						{
						   	String query="select * from images where id='"+id+"' || id='"+img_id+"' || imagename='"+name+"'"; 
				 ...
				 <input  name="image" type="image" src="profile_pic.jsp?id=<%=i%>&type=<%="admin"%>" style="width:200px; height:200px;"/></div></td>
					</tr>
					
					<tr>
					  <td  width="127" valign="middle" height="50" style="color: #00CC99;"><div align="left" class="style3 style4 style14 style7 style8" style="margin-left:20px;">Name</div></td>
	  <td  width="182" valign="middle" height="48" ><div align="left" class="style11" style="margin-left:20px;"><%out.println(s1);%></div></td>
					</tr>
					<tr>
					  <td  width="127" valign="middle" height="48" style="color: #00CC99;"><div align="left" class="style14 style7 style8" style="margin-left:20px;">Description</div></td>
					  <td  width="182" valign="middle" height="48" ><div align="left" class="style11" style="margin-left:20px;"><%out.println(s2);%></div></td>
					</tr>
					<tr>
					  <td  width="127" valign="middle" height="51" style="color: #00CC99;"><div align="left" class="style14 style7 style8" style="margin-left:20px;">Uses</div></td>
					  <td  width="182" valign="middle" height="51"><div align="left" class="style11" style="margin-left:20px;"><%out.println(s3);%></div></td>
					</tr>
					<tr>
<td  width="127" align="left" valign="middle" height="46" style="color: #00CC99;"><div align="left" class="style14 style7 style8" style="margin-left:20px;">Color</div> </td>                    	
<td  width="182" align="left" valign="middle" height="46"><div align="left" class="style11" style="margin-left:20px;"><%out.println(s4);%></div></td>
					...
					<tr>
					  <td  width="127" align="left" valign="middle" height="59" style="color: #00CC99;"><div align="left" class="style14 style7 style8" style="margin-left:20px;">Date</div></td>
					...
					<%if(id==null && img_id==null){%>
					  <p align="right">&nbsp;</p>
					  <p align="right"><a href="keyword_searchresult.jsp">Back</a></p>
					  <%}else if(id==null && name==null){
					  %><p align="right">&nbsp;</p>
					  <p align="right"><a href="similarsearchuser.jsp">Back</a></p><%
					  }else{
					  %><p align="right">&nbsp;</p>
					  <p align="right"><a href="allimages.jsp">Back</a></p><%
					  }
