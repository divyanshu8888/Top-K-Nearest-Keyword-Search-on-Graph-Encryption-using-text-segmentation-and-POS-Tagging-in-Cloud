...
<%
					...
					if ( rs1.next() )
					   ...
					   {
						PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,dob,gender,address,pincode,status,sk,image) values(?,?,?,?,?,?,?,?,'waiting','Generate key',?)");
