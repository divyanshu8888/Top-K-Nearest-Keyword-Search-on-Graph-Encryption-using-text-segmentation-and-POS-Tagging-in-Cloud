...
<head>
<title>all Documents list</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h2 ><em>All Documents List </em></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          ...
          <table width="632" border="3"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse;  margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
            <tr>
              <td  width="86" valign="baseline" height="0" style="color: #2c83b0;"><div align="center" class="style9"> Category </div></td>
              <td  width="88" valign="baseline" height="0" style="color: #2c83b0;"><div align="center" class="style9">Document Name</div></td>
	...
	while ( rs.next() )
	{
		...
		s2=rs.getString(3);
            ...
            <tr>
              ...
              <td  width="120" valign="middle" height="56" style="color:#000000;"align="center"><a href="doc_details1.jsp?mid=<%=i%>">View Details..&nbsp;</a></td>
            </tr>
            <%
						}
						connection.close();
