  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h2 class="style5" >Request Secret Key  </h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
		<form action="secretkey.jsp" method="post">
            <table width="540">
              
			   <tr>
                <td width="229" height="46" bgcolor="#FFFF00"><span class="style4"><strong>Enter Your Password </strong></span></td>
                <td width="171"><input type="password" name="password" /></td>
                <td width="124"><label>
