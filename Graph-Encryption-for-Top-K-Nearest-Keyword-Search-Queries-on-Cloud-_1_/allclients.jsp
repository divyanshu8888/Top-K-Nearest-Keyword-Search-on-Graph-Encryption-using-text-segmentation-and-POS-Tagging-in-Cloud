		...
		<h2 ><em>All Cleint List </em></h2>
          ...
          <table width="632" border="3"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse;  margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
            <tr>
              ...
              <td  width="130" valign="baseline" style="color: #2c83b0;"><div align="center" class="style9">More Information </div></td>
		...
		s4=rs.getString(11);
            ...
            <tr>
              ...
              <%
						...
						%>
              <td  width="54" height="56" align="center" valign="middle">&nbsp;&nbsp; <a href="conformclient.jsp?mid=<%=i%>">waiting&nbsp;</a></td>
              <%
						}
						else
						{
              ...
              <%
						...
						%>
              <td  width="120" valign="middle" height="56" style="color:#000000;"align="center"><a href="client_details.jsp?mid=<%=i%>">more info..&nbsp;</a></td>
            </tr>
            <%
						}
						connection.close();
