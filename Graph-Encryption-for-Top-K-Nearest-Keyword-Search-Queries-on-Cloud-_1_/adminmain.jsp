  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h2 ><em><span class="style3">Welcome to</span> <%=admin%></em></h2>
		<p >&nbsp;</p>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          <h2 class="star style4"><strong>Storage Server </strong></h2>
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><span class="style4"><span class="style5"><a href="adminmain.jsp">Home</a></span></span></li>
            <li class="style3"><a href="allusers.jsp">View All User</a></li>
			  <li class="style3"><a href="allclients.jsp">View All Clients</a></li>
            <li class="style3"><a href="alldocuments.jsp">View All Documents </a></li>
            <li class="style3"><a href="allimages.jsp">View All Images</a></li>
            <li class="style3"><a href="allusers_searchhistory.jsp">Users Search History</a></li>
            <li class="style3"><a href="similarsearchdata.jsp">View Similar Group Data</a></li>
            <li class="style3"><a href="similarsearchuser.jsp">View Similar Search Users</a> </li>
            <li class="style3"><a href="keyword_ratio.jsp">View Search Keyword Ratio</a></li>
            <li class="style3"><a href="keyword_searchresult.jsp">View  <span class="style19">Graph Structure</span> Keyword Result</a></li>
            <li class="style3"><a href="searchdocs&amp;imgs.jsp">View <span class="style19">Graph Structure</span> Search Result</a> </li>
			<li class="style3"><a href="View_Results.jsp">View <span class="style19">File Chart Results</span></a> </li>
				<li class="style3"><a href="View_Results1.jsp">View <span class="style19">Top-k keyword Chart Results</span></a> </li>
