  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h2 ><em><span class="style3">Welcome to</span> <%=user%></em></h2>
		<p >&nbsp;</p>
		<p align="center" class="infopost"><img src="images/User.png" width="395" height="187" /></p>
          <div class="clr"></div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <div class="clr"></div>
          <ul class="sb_menu">
            <li><span class="style4"><a href="usermain.jsp">Home</a></span></li>
            <li><strong><a href="userprofile.jsp">View Profile</a></strong></li>
            <li><strong><a href="requestkey.jsp">Request Secretkey</a> </strong></li>
            <li><strong><a href="search.jsp">Search Queries By Keyword </a></strong></li>
            <li><strong><a href="mysearchhistory.jsp">View Your Search History</a></strong></li>
            <li><strong><a href="keyword_fetchdata.jsp">View Keywords and Its Related Data</a> </strong></li>
