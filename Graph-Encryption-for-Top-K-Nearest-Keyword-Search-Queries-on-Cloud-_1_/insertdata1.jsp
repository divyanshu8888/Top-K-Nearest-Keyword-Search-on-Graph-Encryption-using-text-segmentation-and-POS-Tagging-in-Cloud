					...
					if ( rs1.next() )
					   {
							...
							%>
							<p><a href="userlogin.jsp">Click here to Login</a>         <a href="index.html">Home</a> </p>
					   ...
					   {
						PreparedStatement ps=connection.prepareStatement("insert into client(username,password,email,mobile,dob,gender,address,pincode,status,sk,image) values(?,?,?,?,?,?,?,?,'waiting','Generate key',?)");
