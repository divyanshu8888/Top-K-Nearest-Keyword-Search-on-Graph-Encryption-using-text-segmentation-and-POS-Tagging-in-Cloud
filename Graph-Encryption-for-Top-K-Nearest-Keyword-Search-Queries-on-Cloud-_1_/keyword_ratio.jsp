...
<head>
<title>keyword result in ratio</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		String s1,s2,dt;
		int m=0,n=0,c_doc,ic_doc,t_doc,c_img,ic_img,t_img;
		try{
			
			String sql2="select * from search_result";
			...
			int complete=c_doc+c_img;
			int total=t_doc+t_img;
			
			if(m==0){
			%>
			<tr><td colspan="5"> <div align="center"><span class="style8"> Keyword Searched Ratio </span></div></td>
			</tr>
			<tr>
			...
			<td><div align="left" class="style14 style7 style8 style10" style="margin-left:20px;"><span class="style18">Fetched Ratio</span></div></td>
			...
			<tr >
			  ...
			  <%out.print(s1);%></div></td>
				  ...
				  <%out.print(s2);%></div></td>
				  <td  width="143" valign="middle" height="30"><div align="left" class="style11" style="margin-left:20px;">
			  <%out.print(complete);%><%out.print(":");%><%out.print(total);%></div></td>
