  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
		 <%@page import="com.oreilly.servlet.*,java.sql.*,java.lang.*,java.text.SimpleDateFormat,java.util.*,java.io.*,javax.servlet.*,javax.servlet.http.*" %>
		  ...
		  try
		  {
				  ...
				  String sql="select sk from user where username='"+user+"'";
		...
		<h2 class="style5" >Search Documents and Images </h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
		...
		<form action="searchresults.jsp" method="post">
            <table width="540">
			   ...
			   <tr>
                <td width="229" height="46"><span class="style4"><strong>Enter Keyword to Search </strong></span></td>
                <td width="171"><input type="text" name="keyword" /></td>
                <td width="124"><label>
		...
		%><h2 class="style4">sorry wrong secret key..!!</h2>
		<%
		}
		}
		 connection.close();
