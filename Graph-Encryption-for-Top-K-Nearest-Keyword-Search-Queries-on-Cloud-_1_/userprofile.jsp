  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h2 class="style4" ><strong><em>Profile Details </em></strong></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
	  ...
	  <td  width="182" valign="middle" height="48" ><div align="left" class="style11" style="margin-left:20px;"><%out.println(s1);%></div></td>
					...
					<tr>
					  <td  width="127" valign="middle" height="48" style="color: #00CC99;"><div align="left" class="style4 style8 style7 style14" style="margin-left:20px;"><strong>E-Mail</strong></div></td>
					  <td  width="182" valign="middle" height="48" ><div align="left" class="style11" style="margin-left:20px;"><%out.println(s2);%></div></td>
					</tr>
					<tr>
					  <td  width="127" valign="middle" height="51" style="color: #00CC99;"><div align="left" class="style4 style8 style7 style14" style="margin-left:20px;"><strong>Mobile</strong></div></td>
					  <td  width="182" valign="middle" height="51"><div align="left" class="style11" style="margin-left:20px;"><%out.println(s3);%></div></td>
					</tr>
					<tr>
<td  width="127" align="left" valign="middle" height="46" style="color: #00CC99;"><div align="left" class="style4 style8 style7 style14" style="margin-left:20px;"><strong>Date Of Birth</strong></div> </td>                    	
<td  width="182" align="left" valign="middle" height="46"><div align="left" class="style11" style="margin-left:20px;"><%out.println(s4);%></div></td>
					...
					<tr>
					  <td  width="127" align="left" valign="middle" height="59" style="color: #00CC99;"><div align="left" class="style4 style8 style7 style14" style="margin-left:20px;"><strong>Address</strong></div></td>
