...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style3">Welcome Storage Server Login  </h2>
          <p align="center" class="infopost"><img src="images/Login1.png" width="211" height="144" /></p>
          <div class="clr"></div>
		  <form action="authentication.jsp?type=<%="admin"%>" method="post">
		  
          <table width="480">
            <tr>
              <td width="162" height="48"><span class="style7">User Name (required)</span></td>
                    <td width="347"><input id="name" name="userid" class="text" /></td>
            </tr>
            <tr>
              <td height="44"><span class="style7">Password (required)</span></td>
