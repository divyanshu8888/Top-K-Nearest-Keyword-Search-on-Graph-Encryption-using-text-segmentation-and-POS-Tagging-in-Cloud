...
<head>
<title>searched documents and images</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<h2 class="style19" >Graph Structure --- Keyword Searched Results </h2>
          <p class="infopost">
		  ...
		  try
		 {
			String sql="select distinct type from search_history";
			 Statement st=connection.createStatement();
		 	ResultSet rs=st.executeQuery(sql);			
			while(rs.next())
			{
			String type=rs.getString(1);
			%><p class="style12 style5"><%=num+". "+type%></p>
		
		<%
			
			
		 String sql2="select distinct(result) from search_history where type='"+type+"'";		 		
		 ...
		 %>
		 <p class="style13"><a href="search_details.jsp?name=<%=result%>"><span class="style15 style7"><%="  "+result%></span> </a></p>
     <%}
	 else{ %>
		 <p class="style13"><a href="search_details.jsp?name=<%=result%>"><span class="style15 style7"><%="  "+result%></span> </a></p>
     <%
