...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
	  ...
	  <td  width="182" valign="middle" height="48" ><div align="left" class="style11" style="margin-left:20px;"><%out.println(s1);%></div></td>
					...
					<tr>
					  <td  width="127" valign="middle" height="48" style="color: #00CC99;"><div align="left" class="style3 style8 style7 style14" style="margin-left:20px;"><strong>Description</strong></div></td>
					  <td  width="182" valign="middle" height="48" ><div align="left" class="style11" style="margin-left:20px;"><%out.println(s2);%></div></td>
					</tr>
					<tr>
					  <td  width="127" valign="middle" height="51" style="color: #00CC99;"><div align="left" class="style3 style8 style7 style14" style="margin-left:20px;"><strong>Uses</strong></div></td>
					  <td  width="182" valign="middle" height="51"><div align="left" class="style11" style="margin-left:20px;"><%out.println(s3);%></div></td>
					</tr>
					<tr>
<td  width="127" align="left" valign="middle" height="46" style="color: #00CC99;"><div align="left" class="style3 style8 style7 style14" style="margin-left:20px;"><strong>Color</strong></div> </td>                    	
<td  width="182" align="left" valign="middle" height="46"><div align="left" class="style11" style="margin-left:20px;"><%out.println(s4);%></div></td>
					...
					<tr>
					  <td  width="127" align="left" valign="middle" height="59" style="color: #00CC99;"><div align="left" class="style3 style8 style7 style14" style="margin-left:20px;"><strong>Date</strong></div></td>
